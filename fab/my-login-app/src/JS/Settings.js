                        ...
                        <ul style={{listStyleType: 'none', padding: 0}}>
                            <li className="settings-nav-item">
                                <Link to="/dashboard" style={{
                                    color: 'inherit',
                                    textDecoration: 'none'
                                }}>Dashboard</Link> {/* Link to the dashboard */}
                            </li>
                            <li className="settings-nav-item" onClick={() => setSelectedNav('Manage Users')}>Manage
                                Users
                            </li>
                            <li className="settings-nav-item"
                                onClick={() => setSelectedNav('Notification Settings')}>Notifications
                            </li>
                            <li className="settings-nav-item" onClick={() => setSelectedNav('Account Settings')}>Account
                                Settings
                            </li>
                            <li className="settings-nav-item">
                                <Link to="/" style={{color: 'inherit', textDecoration: 'none'}}>Sign
                                    Out</Link> {/* Link to the dashboard */}
                            </li>
                        </ul>
                    </nav>
                </aside>
