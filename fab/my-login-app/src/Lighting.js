                        ...
                        <div className="lightsControl" style={{
                            ...
                            <div className="roomSelection" style={{flexBasis: '48%'}}>
                                ...
                                <div className="RoomCards" style={{
                                    ...
                                    {/* Room cards */}
                                    <div className="card" style={{width: '40%', marginBottom: '20px'}}><img
                                        class="images" src={bedroomIcon} alt="Room 1"/></div>
                                    <div className="card" style={{width: '40%', marginBottom: '20px'}}><img
                                        class="images" src={bedroomIcon} alt="Room 2"/></div>
                                    <div className="card" style={{width: '40%'}}><img class="images"
                                                                                      src={livingroomIcon}
                                                                                      alt="Room 3"/></div>
                                </div>
                            </div>
